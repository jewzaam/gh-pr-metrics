...
5. **Update documentation** for any changes (requirements, CONTEXT.md)
6. **Run quality checks**: `make format lint test coverage`
7. **Use meaningful commit messages** with `Assisted-by: Cursor (Claude Sonnet 4.5)`
8. **Add "Generated By" header** to new files
